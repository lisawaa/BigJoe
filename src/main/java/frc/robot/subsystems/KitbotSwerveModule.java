...
public class KitbotSwerveModule extends SubsystemBase {
  ...
  public KitbotSwerveModule(int driveID, int turnID, double offset, boolean inverted, SparkMaxConfig config, MotorLocation location) {
